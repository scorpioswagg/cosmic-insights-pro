-- Cosmic Blueprint: ten additional Unfiltered multi-chart synastry products.
...
('synastry-constellation-between-us','THE CONSTELLATION BETWEEN US™','A whole-system reading of the bonds, roles, and patterns among multiple charts.','Unfiltered Series','✦',false,9900,false,true,1009,'synastry-constellation-between-us')
ON CONFLICT (id) DO UPDATE SET title=EXCLUDED.title,tagline=EXCLUDED.tagline,category=EXCLUDED.category,icon=EXCLUDED.icon,is_published=true,slug=EXCLUDED.slug;
